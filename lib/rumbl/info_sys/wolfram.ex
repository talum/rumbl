defmodule Rumbl.InfoSys.Wolfram do
  ...
  def start_link(query, query_ref, owner, limit) do
    ...
    # specify the module and function name to invoke
    # also provide the arguments to be given to the function
  end
  ...
  defp fetch_xml(query_str) do
    {:ok, {_, _, body}} = :httpc.request(
      String.to_charlist("http://api.wolframalpha.com/v2/query" <> "?appid=#{app_id()}" <> "&input=#{URI.encode(query_str)}&format=plaintext"
    ))
    body
  end
